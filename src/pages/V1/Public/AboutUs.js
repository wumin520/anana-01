      ...
      <div className={styles.main}>
        ...
        <div className={styles.au_banner}>
          ...
          <p className={styles.au_desc}>
            真多客作为电子商务服务提供商,致力于为商家提供移动营销的解决方案,通过“一站式导购服务”的模式，提供拼多多等大型电商平台的流量变现等电商一体化服务。
          </p>
          <p className={styles.au_desc}>
            公司总部位于上海，目前已为数十万的商家提供导购服务，我们已经建立起电商内容导购的生态系统，涵盖消费者、商家、第三方流量主及战略联盟伙伴。真多客旨在为商家创造更多价值，得到您100%的信任。
          </p>
        </div>

        <div style={{display: 'none'}} className={styles.qq_block}>
          <div className={styles.qq_item}>
            <img
              className={styles.qq_img}
              src="https://cdn.fengjiangdali.com/image/static/e87b2051050016b10b71035f4302f551894ca632.jpg"
              alt=""
            />
          ...
          <div className={`${styles.qq_item} ${styles.ml64}`}>
            <img
              className={styles.qq_img}
              src="https://cdn.fengjiangdali.com/image/static/a1039e37e6d206c3d2d7facc42c7c545cdfcc1bc.jpg"
              alt=""
            />
