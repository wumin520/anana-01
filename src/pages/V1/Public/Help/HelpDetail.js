...
class HelpDetail extends PureComponent {
  ...
  data = [
    ...
    },
    {
      ...
      r1: '平台规则',
      r2: '私下拉群',
      r3: '1、引导用户加入商家创建的QQ、微信群;2、在和用户聊天过程中提及真多客等',
      r4: '每人次扣1分',
    },
    {
      key: '5',
              ...
              {clickIndex === '1' ? (
                ...
                <Card title="广告服务协议" bordered={false} style={{ width: 872 }}>
                  <p>
                    ...
                    乙方：上海吴钩网络科技有限公司
                    <br />
                    甲乙双方依据《中华人民共和国广告法》、《中华人民共和国合同法》及国家有关法律、法规的规定，在公平、平等、自愿、等价有偿、诚实信用的基础上，经友好协商，现就真多客首焦合作相关事宜达成一致意见。为明确双方权利、义务关系，特签订合同如下，以资信守。
                    <br />
                    <br />
                    第一条：合作原则、目标
                    <br />
                    1.1
                    欢迎您参加“真多客”软件技术服务合作合作，您接受本协议即意味着您同意遵照本协议的规定参加“真多客”的软件技术服务合作活动；
                    <br />
                    1.2 本协议由“甲方（商家）”： 与“乙方”：上海吴钩网络科技有限公司共同订立。
                    <br />
                    <br />
                    第二条：合作内容；
                    <br />
                    ...
                    <br />
                    (2)禁止甲方实际发货商品与活动报名商品不一致，发放产品的质量、商品规格、净含量、质量等与活动报名商品存在偏差，禁止虚假描述、拍A发B给中奖的真多客买家。
                    <br />
                ...
                <Card title="商家vip服务协议" bordered={false} style={{ width: 872 }}>
                  <p>
                    一、 声明与承诺
                    <br />
                    （一）欢迎使用真多客网站商家VIP会员服务（以下简称为“服务”），真多客在此特别提醒用户（您）在使用本网站商家VIP会员服务时必须事先认真阅读本服务条款中各条款，包括免除或者限制真多客责任的免责条款及对用户的权利限制，以决定接受或不接受本声明全部条款。
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    （三）您同意，真多客有权根据需要不时地制订、修改本协议及/或各类规则，并以网站公示的方式进行公告，不再单独通知您，且毋须征得您的事先同意。变更后的协议和规则一经在网站公布后，立即自动生效。您可随时登录真多客网查阅最新版服务条款。如您不同意相关变更，应当立即停止使用商家VIP会员服务。您若继续使用商家VIP会员服务，即表示您接受经修订的协议和规则。
                    <br />
                    <br />
                    ...
                    二、 商家VIP会员服务介绍
                    <br />
                    商家VIP会员服务是真多客商家会员提高品牌和诚信形象的标志，既是商家在真多客诚信认证的过程，也是成为真多客VIP会员商家的标志。开通商家VIP会员服务后，即可点亮VIP会员显示标志，商家的品牌形象随之提升，以达到让更多的消费者信任商家的产品以及有效提升商家销售业绩的目的。可优先得到首页免费的展示位置，关注度也可高出5～10倍；
                    <br />
                    <br />
                    三、 使用规则
                    <br />
                    （一）用户在申请使用真多客网站商家VIP会员服务时，必须向真多客提供准确的个人资料，如个人资料有任何变动，必须及时更新。如果会员提供的信息不真实、不准确、不及时或不完整，或真多客网站有合理的理由怀疑其真实性、准确性、及时性和完整性，真多客则有权中止或终止会员的会员资格并拒绝会员使用任何现有的服务及以后可能提供的功能或服务。
                    <br />
                    <br />
                    （二）用户在使用真多客网站诚信宝服务过程中，必须遵循以下原则：
                    <br />
                    1、在使用商家VIP会员服务过程中实施的所有行为均遵守国家法律法规，不违背社会公共利益或公共道德，不损害他人的合法权益。您如果违反前述承诺，产生任何法律后果的，您应以自己的名义独立承担所有的法律责任，真多客不负任何直接或间接的责任。
                    <br />
                    2、在使用商家VIP会员服务过程中实施的所有行为必须按照真多客各项规则的规定和要求，如有违反行为，真多客将有权中止或终止该服务。
                    <br />
                    ...
                    <br />
                    7.商家不得违反以下规则，否则上海吴钩网络科技有限公司将无条件清退相应商家，终生无法合作，同时将依法追究其法律责任。
                    <br />
                    (1)禁止商家对商品的性能、功能、质量、销售状况、用户评价、曾获荣誉等作虚假或者引人误解的商业宣传，欺骗、误导消费者。
                    <br />
                    (2)禁止商家实际发货商品与活动报名商品不一致，发放产品的质量、商品规格、净含量、质量等与活动报名商品存在偏差，禁止虚假描述、拍A发B给中奖的真多客买家。
                    <br />
                    (3)商家在使用真多客平台进行营销活动过程中，应当遵循自愿、平等、公平、诚信的原则，遵守法律和商业道德。
                    <br />
                    8.活动发布时，可能会产生的活动费用。
                    <br />
                    ...
                    <br />
                    <br />
                    （三）商家审批用户时不能审批内部员工、亲朋好友等虚假用户；必须确保发给用户的返利商品与返利活动页面的描述一致；必须确保用户到指定平台模拟购买时，返利商品单价与返利活动页面的返利担保金一致；在活动期间在未告知用户其正在做推广的情况下，不可诱导用户通过链接拍付返利商品；不得向申请返利的用户提出无理要求，如强行要求用户进行推广、分享、或者打全5分等行为；若商家违反上述内容，真多客将有权调用、曝光和处理用户在真多客的所有信息，并不退予商家一切款项。
                    <br />
                    <br />
                    四、协议终止
                    <br />
                    （一）真多客有权根据需要不时地制订、修改本协议及/或各类规则，服务条款一旦发生变动，公司将会在页面提示修改内容。修订后的条款内容自公告时起生效，并成为本协议的一部分。用户若在本协议修改之后，仍继续使用本网站，则视为用户接受和自愿遵守修订后的协议。本网站行使修改或中断服务时，不需对任何第三方负责。用户要继续使用真多客网站诚信宝服务需要两方面的确认：
                    <br />
                    1、首先确认真多客网站服务条款及其变动。
                    <br />
                    2、同意接受所有的服务条款限制。
                    <br />
                    <br />
                    （二）真多客网站保留随时修改或中断服务而不需通知用户的权利。真多客修改或中断服务的权利，真多客不需对用户或第三方负责；
                    <br />
                    <br />
                    ...
                    4、其它本网站认为需终止服务的情况。
                    <br />
                    5、商家因为产品出现三无问题和用户发生纠纷的（无生产日期、无质量合格证以及无生产厂家等来路不明的产品），经真多客核查情况属实的，立即终止服务。
                    <br />
                    <br />
                    五、本网站的责任范围
                    <br />
                    （一）当用户接受该协议时，用户应明确了解并同意：用户使用本网站的风险由用户个人负担。本网站是在现有技术基础上提供的。包括但不限于对服务的可适用性，没有错误或疏漏，持续性，准确性，可靠性，适用于某一特定用途之类的保证，声明或承诺。真多客对服务所涉的技术和信息的有效性、准确性、可靠性、稳定性和及时性均不作承诺和保证。
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    （三）不论是否可以预见，不论是源于何种形式的行为，真多客不对由以下原因造成的任何特别的、直接的、间接的、惩罚性的、突发性的或有因果关系的损害或其他任何损害（包括但不限于利润或利息的损失，营业中断，资料灭失）承担责任。该条款可以扩展到法律所排斥的或不受法律约束的范畴。
                    <br />
                    1、使用或不能使用本服务。
                    <br />
                    ...
                    六、知识产权
                    <br />
                    真多客是所有权利的拥有者，本网站及本网站所使用的任何相关软件、程序、内容，包括但不限于作品、图片、档案、资料、网站构架、网站版面的安排、网页设计、经由本网站或广告商向用户呈现的广告或资讯，均由本网站或其它权利人依法享有相应的知识产权，包括但不限于著作权、商标权、专利权或其它专属权利等，受到相关法律的保护。
                    <br />
                    <br />
                    七、争议解决方式
                    <br />
                    ...
                    <br />
                    （二）本协议签订地为中国上海市。因本协议所引起的用户与真多客的任何纠纷或争议，首先应友好协商解决，协商不成的，用户在此完全同意将纠纷或争议提交真多客所在地管辖权的人民法院诉讼解决。
                    <br />
                    <br />
                    八、其他
                    <br />
              ...
              {globalKey === 10 ? (
                ...
                <Card title={EnterData[2].title} bordered={false}>
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <p>
                      用户进入真多客官网后，在导航栏顶部可以看到“登录/注册”入口菜单，注册登录后，点击“商家认证”，输入商家相关的信息，认证成功后即可进入放单中心页面，使用你的真多客账号密码即可登录放单系统。(
                    ...
                    <p>2、认证后，请优先了解《真多客放单基本规范》后再进行放单操作！</p>
                  ...
                  <div>
                    ...
                    <p>
                      优质好单是畅销的基础，也是平台发展的关键，我们始终希望真多客能够成为好单的聚集地，我们特别欢迎有一定实力的商家认证，放单用户应能够：
                    </p>
                    <p>① 有相应的经验辨别好单；</p>
                ...
                <Card title={StandardData[0].title} bordered={false}>
                  ...
                  <div style={{ marginBottom: 30 }}>
                    ...
                    <p>商品主图直接呈现在真多客平台上，至关重要，要求图片精美，突出主题。</p>
                ...
                <Card title={StandardData[1].title} bordered={false}>
                  <p>
                    目前真多客商品信息均来源于拼多多平台，仅支持商品主图及短标题的修改，不支持文案等推广内容的编辑，后期将对商品信息进行自定义输出，更佳精细化的展示商品的特色，以供用户能有更深刻美好的印象，提高商品转化率
                  </p>
                </Card>
              ) : globalKey === 6 ? (
                ...
                <Card title={illegalData[0].title} bordered={false}>
                  ...
                  <p>
                    1、真多客为保障双方资金和交易安全，真多客有权根据实际情况暂时或者永久限制商家使用部分功能。若商家需要解除限制的，需根据真多客的要求提供相应证明材料并提供相应的保证措施。
                  </p>
                  <p>
                    2、若商家存在交易纠纷未处理完成且拒不处理的，在交易纠纷处理完毕前，真多客有权停止商家在真多客平台发布任何活动。
                  </p>
                  <p>
                    3、若商家存在违规行为的，真多客有权未经商家许可，直接终止违规行为相关的活动。
                  </p>
                  <p>
                ...
                <Card title={illegalData[2].title} bordered={false} style={{ width: 872 }}>
                  <p>因下列原因造成第三方及用户损失，第三方可以向真多客提出投诉：</p>
