              ...
              <div className={styles.notice_content}>
                <div className={styles.introduction}>
                  <p className={styles.intr_title}>
                    <img
                      ...
                      src="https://cdn.fengjiangdali.com/image/static/bbdad5dacc0ae98f8572d47694d7cfec0e14cda5.jpg"
                      alt=""
                    />
                    <span>认证须知</span>
                  </p>
                ...
                <div className={styles.introduction}>
                  <p className={styles.intr_title}>
                    <img
                      className={styles.intr_img}
                      src="https://cdn.fengjiangdali.com/image/static/07c40a2e9715922debd8b5dfae200a977c77bb8c.jpg"
                      alt=""
                    />
                    <span>商品规范</span>
                  </p>
                ...
                <div className={styles.introduction}>
                  <p className={styles.intr_title}>
                    <img
                      className={styles.intr_img}
                      src="https://cdn.fengjiangdali.com/image/static/f0f26f36d4dbbe74dfdbc82ce5cf47f1daea1446.jpg"
                      alt=""
                    />
                    <span>违规规则</span>
                  </p>
